...
import { MovieCategory } from "./shared/enumerations";
...
class Movie extends Sequelize.Model<Optional<IMoviesAttributes, 'id' | 'createdAt' | 'updatedAt' | 'like_count' | 'user_id'>> implements IMoviesAttributes {
  public id!: number;
  public title!: string;
